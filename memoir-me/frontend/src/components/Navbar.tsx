...
export const Navbar = () =>{
    return <div >
        <header className=">flex flex-wrap sm:justify-start sm:flex-nowrap w-full text-sm  border-b "> 
            {/* dark:bg-neutral-800 */}
  <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
    <div className="flex items-center ">
        
    <a className="  text-2xl font-extrabold font-serif pt-2	" href="blogs"> Memoir me</a>
      <div className=" size-4/12  pr-4" ><img src={logo} alt="" /></div>  
